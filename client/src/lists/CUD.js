        ...
        return (
            <div>
                ...
                <Form stateOwner={this} onSubmitAsync={::this.submitHandler}>
                    ...
                    {toNameFields}
                    <NamespaceFilterContext.Consumer>{(context) => <TableSelect id="send_configuration" label={t('sendConfiguration')} withHeader dropdown dataUrl='rest/send-configurations-table' columns={sendConfigurationsColumns} selectionLabelIndex={1} help={t('sendConfigurationThatWillBeUsedFor')} namespaceFilter={context.namespaceId}/>}</NamespaceFilterContext.Consumer>
