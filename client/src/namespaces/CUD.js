...
import {getDefaultNamespace, getNamespaceFilterId} from "../lib/namespace";
        ...
        return (
            <div>
                ...
                <Form stateOwner={this} onSubmitAsync={::this.submitHandler}>
                    ...
                    {!this.isEditGlobal() &&
                    <TreeTableSelect id="namespace" label={t('parentNamespace')} data={this.state.treeData} namespaceFilter={getNamespaceFilterId()}/>}
