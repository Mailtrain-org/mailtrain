/** 
 * Mosaico - OpenSource Email Template Editor - v0.17.5 - 2019-05-08 
...
"use strict";var utils=require("./utils");module.exports=function(e){function t(t,s,n){n=n||{};var a=utils.parseCSS(s),o=[],i="style";if(n.styleAttributeName&&(i=n.styleAttributeName),a.forEach(function(s){for(var a,l=s[0],u=s[1],p=new utils.Selector(l),c=p.parsed(),f=function(e){if(0===e.length)return;var t=e[e.length-1].pseudos;if(!t)return;for(var s=0;s<t.length;s++)if(r(t[s]))return t[s].name}(c),d=0;d<c.length;++d){var v=c[d];if(v.pseudos)for(var m=0;m<v.pseudos.length;++m){var y=v.pseudos[m];if(e.ignoredPseudos.indexOf(y.name)>=0)return}}if(f){var h=c[c.length-1],g=h.pseudos;h.pseudos=function(e){return e.filter(function(e){return!r(e)})}(h.pseudos),l=c.toString(),h.pseudos=g}try{a=t(l)}catch(e){return}a.each(function(){var r=this;if(!(r.name&&e.nonVisualElements.indexOf(r.name.toUpperCase())>=0)){if(f){var s="pseudo"+f,a=r[s];a||((a=r[s]=t("<span />").get(0)).pseudoElementType=f,a.pseudoElementParent=r,r[s]=a),r=a}if(!r.styleProps){if(r.styleProps={},t(r).attr(i)){var l="* { "+t(r).attr(i)+" } ";c(utils.parseCSS(l)[0][1],new utils.Selector("<style>",!0))}o.push(r)}c(u,p)}function c(t,s){for(var a=0,o=t.length;a<o;a++)if("property"==t[a].type){var i=t[a].name,l=t[a].value,u=null!==t[a].value.match(/!important$/);u&&!n.preserveImportant&&(l=l.replace(/\s*!important$/,""));var p=[t[a].position.start.line,t[a].position.start.col],c=new utils.Property(i,l,s,u?2:0,p),f=r.styleProps[i];e.excludedProperties.indexOf(i)<0&&(f&&f.compare(c)===c||!f)&&(f&&f.selector!==s?delete r.styleProps[i]:f&&(c.nextProp=f),r.styleProps[i]=c)}}})}),o.forEach(function(e){Object.keys(e.styleProps).length;var r=[];Object.keys(e.styleProps).forEach(function(t){for(var s=e.styleProps[t];void 0!==s;)r.push(s),s=s.nextProp}),r.sort(function(e,t){return e.compareFunc(t)});var s=r.filter(function(e){return"content"!==e.prop}).map(function(e){return e.prop+": "+e.value.replace(/["]/g,"'")+";"}).join(" ");s&&t(e).attr(i,s)}),n.inlinePseudoElements&&o.forEach(function(e){if(e.pseudoElementType&&e.styleProps.content){var r=function(e){if("none"===e||"normal"===e)return"";var t=e.match(/^\s*url\s*\(\s*(.*?)\s*\)\s*$/i);if(t){var r=t[1].replace(/^['"]|['"]$/g,"");return{img:r}}return e=(e=e.slice(1,e.length-1)).replace(/\\/g,"")}(e.styleProps.content.value);r.img?(e.name="img",t(e).attr("src",r.img)):t(e).text(r);var s=e.pseudoElementParent;"before"===e.pseudoElementType?t(s).prepend(e):t(s).append(e)}}),n.applyWidthAttributes&&o.forEach(function(e){p(e,"width")}),n.applyHeightAttributes&&o.forEach(function(e){p(e,"height")}),n.applyAttributesTableElements&&o.forEach(function(r){if(!r.name)return;var s=r.name.toUpperCase(),n=Object.keys(e.styleToAttribute);if(e.tableElements.indexOf(s)>-1)for(var a in r.styleProps)if(n.indexOf(r.styleProps[a].prop)>-1){var o=e.styleToAttribute[r.styleProps[a].prop],i=r.styleProps[a].value;if("background"===o&&(i=c(i)),/(linear|radial)-gradient\(/i.test(i))continue;t(r).attr(o,i)}}),n.insertPreservedExtraCss&&n.extraCss){var l=utils.getPreservedText(n.extraCss,{mediaQueries:n.preserveMediaQueries,fontFaces:n.preserveFontFaces,keyFrames:n.preserveKeyFrames});if(l){var u=null;!0!==n.insertPreservedExtraCss?u=t(n.insertPreservedExtraCss):((u=t("head")).length||(u=t("body")),u.length||(u=t.root())),u.first().append("<style>"+l+"</style>")}}function p(r,s){if(r.name){var n=r.name.toUpperCase();if(e[s+"Elements"].indexOf(n)>-1)for(var a in r.styleProps)if(r.styleProps[a].prop===s){if(r.styleProps[a].value.match(/px/)){var o=r.styleProps[a].value.replace("px","");return void t(r).attr(s,o)}if(e.tableElements.indexOf(n)>-1&&r.styleProps[a].value.match(/\%/))return void t(r).attr(s,r.styleProps[a].value)}}}function c(e){return 0!==e.indexOf("url(")?e:e.replace(/^url\((["'])?([^"']+)\1\)$/,"$2")}}function r(e){return"before"===e.name||"after"===e.name}return e.ignoredPseudos=["hover","active","focus","visited","link"],e.widthElements=["TABLE","TD","TH","IMG"],e.heightElements=["TABLE","TD","TH","IMG"],e.tableElements=["TABLE","TH","TR","TD","CAPTION","COLGROUP","COL","THEAD","TBODY","TFOOT"],e.nonVisualElements=["HEAD","TITLE","BASE","LINK","STYLE","META","SCRIPT","NOSCRIPT"],e.styleToAttribute={"background-color":"bgcolor","background-image":"background","text-align":"align","vertical-align":"valign"},e.excludedProperties=[],e.juiceDocument=function(r,s){s=utils.getDefaultOptions(s);var n=function(t,r){return function(t,r){var s,n,a,o=[];return t("style").each(function(){if(1===(s=(a=this).childNodes).length){if(n=s[0].data,r.applyStyleTags&&void 0===t(a).attr("data-embed")&&o.push(n),r.removeStyleTags&&void 0===t(a).attr("data-embed")){var i=utils.getPreservedText(a.childNodes[0].nodeValue,{mediaQueries:r.preserveMediaQueries,fontFaces:r.preserveFontFaces,keyFrames:r.preserveKeyFrames,pseudos:r.preservePseudos},e.ignoredPseudos);i?a.childNodes[0].nodeValue=i:t(a).remove()}t(a).removeAttr("data-embed")}}),o}(t,r).join("\n")}(r,s);return n+="\n"+s.extraCss,t(r,n,s),r},e.inlineDocument=t,e};
...
(function (global){
!function(e){"function"==typeof require&&"object"==typeof exports&&"object"==typeof module?e("undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null):"function"==typeof define&&define.amd?define(["knockout"],e):e(window.ko)}(function(e){e.subscribable.fn.watch=function(t,a,n,o){var r=typeof t;return"boolean"==r||"undefined"==r?e.watch(this,{enabled:!1!==t}):"function"!=r||e.isSubscribable(t)?e.watch(t,a,n,o||this):e.watch(this,a||{},t,o||this),this},e.watch=function(t,a,n,o){function r(l,c,f,u,s,b){if(l&&0!==a.depth&&(-1===a.depth||f.length<(a.depth||1))){if(a.watchedOnly&&!l.watchable&&l!=t)return;if(!1!==a.enabled&&!0!==a.enabled||(l.watchable=a.enabled),!1===l.watchable)return;!0===a.seal&&(l.watchable=!1);var d=typeof l;if("object"==d||"function"==d){if(l._watcher===o)return;if(a.hide&&-1<e.utils.arrayIndexOf(a.hide,l))return;var h=[].concat(f,c&&c!==t?c:[]);if("function"!=d){if("[object Object]"===Object.prototype.toString.call(l))e.utils.objectForEach(l,function(t,n){if(n=a.getter?a.getter.call(o,h,l,t):n){if(a.wrap){var i=Object.prototype.toString.call(n);"[object Function]"!==i&&"[object Object]"!==i&&(a.beforeWrap&&!1===a.beforeWrap.call(o,h,l,n)||(n=l[t]="[object Array]"===i?e.observableArray(n):e.observable(n)))}a.unloop&&(n._watcher=u?void 0:o);var c=r(n,s?null:l,h,u,null,t);a.tagFields&&void 0===n._fieldName&&(c||"parentsOnly"!==a.tagFields&&"function"==typeof n||"object"==typeof n)&&(n._fieldName=t)}});else if(!0!==a.hideArrays)for(var p=0;p<l.length;p++)r(l[p],s?null:l,h,u);return!0}if("function"==typeof l.notifySubscribers&&n){if(!0===a.enabled&&!1===l.watchable)return;if(u||!a.beforeWatch||!1!==a.beforeWatch.call(o,h,l,b)){var y="function"==typeof l.pop;if(u?function(e){var t=e[i];if(!t)throw"Subscriptions field (."+i+") not defined for observable child "+(e._fieldName||"");if(t.change)for(var n=t.change.length-1;0<=n;n--)t.change[n]._watcher===o&&t.change[n].dispose();if(t.beforeChange&&(a.mutable||0<a.oldValues))for(n=t.beforeChange.length-1;0<=n;n--)t.beforeChange[n]._watcher===o&&t.beforeChange[n].dispose();if(t.arrayChange)for(n=t.arrayChange.length-1;0<=n;n--)t.arrayChange[n]._watcher===o&&t.arrayChange[n].dispose()}(l):function(t,i,l,c){y?t.subscribe(function(i){var f;!1===a.splitArrayChanges&&void 0!==(f=n.call(o,l,t,i))&&o(f),e.utils.arrayForEach(i,function(e){if(!1!==a.splitArrayChanges){var i=n.call(o,l,t,e);void 0!==i&&o(i)}e.moved||(!1===a.async?r(e.value,c?null:t,l,"deleted"===e.status):setTimeout(function(){r(e.value,c?null:t,l,"deleted"===e.status)}))})},void 0,"arrayChange")._watcher=o:(t.subscribe(function(){if(!1!==t.watchable){var e=n.call(o,l,t);void 0!==e&&o(e),a.mutable&&"object"==typeof t()&&(!1===a.async?r(t(),c?null:t,l,!1,!0):setTimeout(function(){r(t(),c?null:t,l,!1,!0)}))}},null,"change")._watcher=o,(0<a.oldValues||a.mutable)&&(t.subscribe(function(e){if(0<a.oldValues){var n=t.oldValues?t.oldValues:t.oldValues=[];for(n.unshift(e);n.length>a.oldValues;)n.pop()}a.mutable&&"object"==typeof e&&r(e,c?null:t,l,!0,!0)},null,"beforeChange")._watcher=o))}(l,0,h,s),y)return r(l(),s?null:l,h,u,!0),!0;if(!0!==a.hideWrappedValues)return r(l(),s?null:l,h,u,!0)}}}}}var i;switch("function"==typeof a&&(o=o||n,n=a,a={}),o=o||this,"function"==typeof e.subscription||e.version){case!0:i="_subscriptions";break;case"3.0.0":i="F";break;case"3.1.0":i="H";break;case"3.2.0":i="M";break;case"3.3.0":i="G";break;case"3.4.0":case"3.4.1":i="K";break;case"3.4.2":i="F";break;case"3.5.0":i="S";break;default:throw"Unsupported Knockout version. Only v3.0.0 to v3.5.0 finals are supported when minified. Current version is "+e.version}return"function"!=typeof t||e.isSubscribable(t)?(r(t,null,[]),{dispose:function(){r(t,null,[],!0)}}):e.computed(t,n,a)}}),window.foo="1.4.1";
...
(function (global){
"use strict";var beforeSubscriptionProp,afterSubscriptionProp,ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,console=require("console-browserify");if(ko.bindingHandlers.ifSubs={cloneNodes:function(o,e){for(var i=0,n=o.length,r=[];i<n;i++){var s=o[i].cloneNode(!0);r.push(e?ko.cleanNode(s):s)}return r},init:function(o,e,i,n,r){var s,t,u=e();return void 0===u.data.subsCount&&ko.extenders.subscriptionsCount(u.data),ko.computed(function(){var i,n,b=ko.utils.unwrapObservable(e().data.subsCount),p=!t;n=-(void 0!==e().gutter?e().gutter:1),i=b+(s?n:0)>=ko.utils.unwrapObservable(u.threshold),void 0!==e().not&&e().not&&(i=!i),(p||i!==s)&&(p&&ko.computedContext.getDependenciesCount()&&(t=ko.bindingHandlers.ifSubs.cloneNodes(ko.virtualElements.childNodes(o),!0)),i?(p||ko.virtualElements.setDomNodeChildren(o,ko.bindingHandlers.ifSubs.cloneNodes(t)),ko.applyBindingsToDescendants(r,o)):ko.virtualElements.emptyNode(o),s=i)},null,{disposeWhenNodeIsRemoved:o}),{controlsDescendantBindings:!0}}},ko.virtualElements.allowedBindings.ifSubs=!0,"function"==typeof ko.subscription&&void 0!==ko.isWritableObservable)beforeSubscriptionProp="beforeSubscriptionAdd",afterSubscriptionProp="afterSubscriptionRemove";else if("3.2.0"==ko.version)beforeSubscriptionProp="va",afterSubscriptionProp="nb";else if("3.3.0"==ko.version)beforeSubscriptionProp="ja",afterSubscriptionProp="ua";else if("3.4.0"==ko.version)beforeSubscriptionProp="sa",afterSubscriptionProp="Ia";else if("3.4.1"==ko.version)beforeSubscriptionProp="sa",afterSubscriptionProp="Ia";else if("3.4.2"==ko.version)beforeSubscriptionProp="ua",afterSubscriptionProp="Ka";else{if("3.5.0"!=ko.version)throw"Unsupported minimized Knockout version "+ko.version+" (supported DEBUG or minimized 3.2.0 ... 3.5.0)";beforeSubscriptionProp="Qa",afterSubscriptionProp="cb"}ko.extenders.subscriptionsCount=function(o,e,i){if(void 0===o.subsCount){o.subsCount=ko.observable(o.getSubscriptionsCount()).extend({notify:"always"});var n=o[beforeSubscriptionProp],r=o[afterSubscriptionProp];o[beforeSubscriptionProp]=function(r){n&&n.call(o,r);var s=o.getSubscriptionsCount()+1;void 0!==e&&s!=e&&void 0!==i&&s!=i||o.subsCount(s)},o[afterSubscriptionProp]=function(n){r&&r.call(o,n);var s=o.getSubscriptionsCount();void 0!==e&&s!=e&&void 0!==i&&s!=i||o.subsCount(s)}}else console.log("already applied subscriptionCount to observable");return null};
...
"use strict";var converterUtils=require("./utils.js"),cssParse=require("mensch/lib/parser.js"),console=require("console-browserify"),domutils=require("./domutils.js"),_declarationValueLookup=function(e,t,r){for(var l=e.length-1;l>=0;l--)if("property"==e[l].type&&e[l].name==t)return _declarationValueUrlPrefixer(e[l].value,r);return null},_propToCamelCase=function(e){return e.replace(/-([a-z])/g,function(e,t,r,l){return t.toUpperCase()})},_declarationValueUrlPrefixer=function(e,t){return e.match(/url\(.*\)/)?e.replace(/(url\()([^\)]*)(\))/g,function(e,r,l,i){var n=l.trim(),o=l.trim().charAt(0);"'"==o||'"'==o?n=n.substr(1,n.length-2):o="";var a=t(n);return null!==a?r+o+a+o+i:e}):e},elaborateDeclarations=function(e,t,r,l,i,n,o){var a="object"==typeof n&&null!==n?n:{},u=null,s=0;void 0===t&&(t=cssParse("#{\n"+e+"}",{comments:!0,position:!0}).stylesheet.rules[0].declarations,s=1);for(var v=t.length-1;v>=0;v--)if("property"==t[v].type)if(!0===o&&"display"==t[v].name&&"none"==t[v].value)null===u&&(u=e),u=converterUtils.removeStyle(u,t[v].position.start,t[v].position.end,s,0,0,"");else{var d=t[v].name.match(/^-ko-(bind-|attr-)?([a-z0-9-]*?)(-if|-ifnot)?$/);if(null!==d){null===u&&void 0!==e&&(u=e);var c,f,m,p="attr-"==d[1],y="bind-"==d[1],h=d[2],b="-if"==d[3]||"-ifnot"==d[3];if(b){if(c=t[v].name.substr(0,t[v].name.length-d[3].length),null===_declarationValueLookup(t,c,r))throw"Unable to find declaration "+c+" for "+t[v].name}else{if((p||y)&&void 0===i&&void 0!==e)throw"Attributes and bind declarations are only allowed in inline styles!";var S,g=!0;if(p?(m=domutils.getAttribute(i,h),g=!1,S="virtualAttr"):y?(S=null,"text"==h?void 0!==i?m=domutils.getInnerText(i):g=!1:"html"==h&&void 0!==i?m=domutils.getInnerHtml(i):g=!1):((g=void 0!==e)&&(m=_declarationValueLookup(t,h,r)),S="virtualStyle"),g&&null===m)throw console.error("Cannot find default value for",t[v].name,t),"Cannot find default value for "+t[v].name+": "+t[v].value+" in "+i+" ("+typeof e+"/"+h+")";var w=m,U=y||p?-1!=h.indexOf("-")?"'"+h+"'":h:_propToCamelCase(h);try{f=converterUtils.expressionBinding(t[v].value,l,w)}catch(e){throw console.error("Model ensure path failed",e.stack,"name",t[v].name,"value",t[v].value,"default",m,"element",i),e}null!==S&&void 0===a[S]&&(a[S]={}),"virtualAttr"==S&&"href"==U&&(S=null,U="wysiwygHref",null!=i&&domutils.removeAttribute(i,"href"));var x=_declarationValueLookup(t,t[v].name+"-if",r),A=!1;if(null===x)x=_declarationValueLookup(t,t[v].name+"-ifnot",r),A=!0;else if(null!==_declarationValueLookup(t,t[v].name+"-ifnot",r))throw"Unexpected error: cannot use both -if and -ifnot property conditions";if(null!==x)try{var _=converterUtils.conditionBinding(x,l);_.match(/^[^' ]*[^' \)]$/)&&(_="ko.utils.unwrapObservable("+_+")"),f.match(/^[^' ]*[^' \)]$/)&&(f="ko.utils.unwrapObservable("+f+")"),A&&(_="!"+_),f=_+" ? "+f+" : null"}catch(e){throw console.error("Unable to deal with -ko style binding condition",x,t[v].name),e}null!==S?a[S][U]=f:a[U]=f}if(null!==u)try{if(null!=i)u=converterUtils.removeStyle(u,t[v].position.start,t[v].position.end,s,0,0,"");else{var k="";b||(k=h+": \x3c!-- ko text: "+f+" --\x3e"+m+"\x3c!-- /ko --\x3e"),u=converterUtils.removeStyle(u,t[v].position.start,t[v].position.end,s,0,0,k)}}catch(e){throw console.warn("Remove style failed",e,"name",t[v]),e}}else{var C=_declarationValueUrlPrefixer(t[v].value,r);if(C!=t[v].value&&(null===u&&void 0!==e&&(u=e),null!==u))try{u=converterUtils.removeStyle(u,t[v].position.start,t[v].position.end,s,0,0,t[v].name+": "+C)}catch(e){throw console.log("Remove style failed replacing url",e,"name",t[v]),e}var V=_propToCamelCase(t[v].name),P="virtualAttrStyle",O=void 0!==a.virtualStyle?a.virtualStyle[V]:void 0,j=" ";void 0===a[P]&&(a[P]="''",j=""),void 0!==O?(O.match(/^[^' ]*[^' \)]$/)&&(O="ko.utils.unwrapObservable("+O+")"),a[P]="'"+t[v].name+": '+"+O+"+';"+j+"'+"+a[P],delete a.virtualStyle[V]):a[P]="'"+t[v].name+": "+converterUtils.addSlashes(C)+";"+j+"'+"+a[P]}}if(null!=i){for(var z in a.virtualStyle)if(a.virtualStyle.hasOwnProperty(z))throw console.log("Unexpected virtualStyle binding after conversion to virtualAttr.style",z,a.virtualStyle[z],e),"Unexpected virtualStyle binding after conversion to virtualAttr.style for "+z;delete a.virtualStyle;var L=domutils.getAttribute(i,"data-bind"),q=(null!==L?L+", ":"")+_bindingSerializer(a);""==q?domutils.removeAttribute(i,"data-bind"):domutils.setAttribute(i,"data-bind",q)}if(void 0===e){var T=!1;for(var $ in a.virtualStyle)if(a.virtualStyle.hasOwnProperty($)){T=!0;break}if(T){if(void 0!==a.virtualAttrStyle){var B=a.virtualAttrStyle;delete a.virtualAttrStyle,a.virtualAttrStyle=B}}else delete a.virtualStyle;return _bindingSerializer(a)}return u},_bindingSerializer=function(e){var t=[];for(var r in e)e.hasOwnProperty(r)&&("object"==typeof e[r]?t.push(r+": { "+_bindingSerializer(e[r])+" }"):t.push(r+": "+e[r]));return t.reverse().join(", ")};module.exports=elaborateDeclarations;
...
"use strict";var console=require("console-browserify"),jsep=require("jsep");jsep.addBinaryOp("or",1),jsep.addBinaryOp("and",2),jsep.addBinaryOp("eq",6),jsep.addBinaryOp("neq",6),jsep.addBinaryOp("lt",7),jsep.addBinaryOp("lte",7),jsep.addBinaryOp("gt",7),jsep.addBinaryOp("gte",7);var addSlashes=function(e){return e.replace(/[\\"'\r\n\t\v\f\b]/g,"\\$&").replace(/\u0000/g,"\\0")},removeStyle=function(e,r,n,t,i,a,o){for(var s=e.split("\n"),p=i,l=a,d=1+t;d<r.line;d++)p+=s[d-1-t].length+1;if(p+=r.col,null!==n){for(var c=1+t;c<n.line;c++)l+=s[c-1-t].length+1;l+=n.col}else l+=e.length+1;return e.substr(0,p-1)+o+e.substr(l-1)},conditionBinding=function(e,r,n){return function e(r,n,t,i){if("BinaryExpression"===r.type||"LogicalExpression"===r.type)return"("+e(r.left,n,t)+" "+function(e){switch(e){case"or":return"||";case"and":return"&&";case"lt":return"<";case"lte":return"<=";case"gt":return">";case"gte":return">=";case"eq":return"==";case"neq":return"!=";default:return e}}(r.operator)+" "+e(r.right,n,t)+")";if("CallExpression"===r.type){var a=r.arguments.map(function(r){return e(r,n,t)});return e(r.callee,n,t)+"("+a.join(", ")+")"}if("UnaryExpression"===r.type)return r.operator+e(r.argument,n,t);if("MemberExpression"==r.type&&r.computed)throw"Unexpected computed member expression";if("MemberExpression"!=r.type||r.computed){if("Literal"===r.type)return r.raw;if("Identifier"===r.type){var o=r.name;return t?n(o,i)+"()":o}if("ConditionalExpression"===r.type)return"("+e(r.test,n,t)+" ? "+e(r.consequent,n,t)+" : "+e(r.alternate,n,t)+")";throw"Compound"===r.type?"Syntax error in expression: operator expected after "+e(r.body[0],n,!1):"Found an unsupported expression type: "+r.type}var s=e(r.object,n,!1)+"."+e(r.property,n,!1);return t&&"Math"!==r.object.name&&"Color"!==r.object.name&&"Util"!==r.object.name?n(s,i)+"()":s}(jsep(e),r,!0,n)},expressionBinding=function(e,r,n){var t;if(null!=n){var i=e.trim().replace(/@\[([^\]]+)\]|@([a-zA-Z0-9\._]+)\b/g,"###var###");if("###var###"==(i=i.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")))t=[null,n];else if(i="^"+i.replace(/###var###/g,"(.+)")+"$",!(t=n.trim().match(new RegExp(i))))throw console.error("Cannot find matches",t,"for",n,e,i,e),"Cannot find default value for "+e+" in "+n}try{var a=0,o="'"+e.replace(/@\[([^\]]+)\]|@([a-zA-Z0-9\._]+)\b|(')/g,function(e,n,i,o){if(o)return"\\"+o;a++;var s,p=n||i;if(t){if(void 0===t[a])throw console.log("Cannot find default value for",p,"in",t,"as",a),"Cannot find default value for "+p+" at "+a;s=t[a].trim()}return n?"'+"+conditionBinding(n,r,s)+"+'":"'+"+r(p,s)+"()+'"})+"'";if(o=o.replace(/^''\+/,"").replace(/\+''$/,"").replace(/^([^'+ ]*)\(\)$/,"$1"),0===a&&"false"!==o&&"true"!==o)throw console.error("Unexpected expression with no valid @variable references",e),"Unexpected expression with no valid @variable references: "+e;return o}catch(r){throw"Exception parsing expression "+e+" "+r}};module.exports={addSlashes:addSlashes,removeStyle:removeStyle,conditionBinding:conditionBinding,expressionBinding:expressionBinding};

},{"console-browserify":6,"jsep":10}],60:[function(require,module,exports){
(function (global){
"use strict";var ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,console=require("console-browserify");function wrap(e){var t=typeof e;if("object"===t&&(e?e.constructor==Date?t="date":"[object Array]"==Object.prototype.toString.call(e)&&(t="array"):t="null"),"array"==t){var n=ko.observableArray();if(!e||0===e.length)return n;for(var r=0,o=e.length;r<o;++r)n.push(wrap(e[r]));return n}if("object"==t){var a={};for(var i in e){var l=e[i];a[i]=wrap(l)}return ko.observable(a)}if("function"==t)return e;var s=ko.observable();return s(e),s}var _getOptionsObjectKeys=function(e){for(var t=e.split("|"),n=[],r=0;r<t.length;r++){var o=t[r].split("=");n.push(o[0].trim())}return n},_makeComputed=function(e,t,n,r,o,a){return ko.computed({read:function(){var n=e();if(null===n){var i=ko.utils.unwrapObservable(r);return void 0===i||"custom"==i?ko.utils.unwrapObservable(t):a[i][o]}return n},write:function(i){var l,s=ko.utils.unwrapObservable(r);if(l=void 0===s||"custom"==s?ko.utils.peekObservable(t):a[s][o],n)e(i==l?null:i);else{var u=ko.utils.peekObservable(e);i==l&&null===u||e(i)}}})},_nextVariantFunction=function(e,t,n){for(var r=e.utils.unwrapObservable(t),o=0;o<n.length&&e.utils.peekObservable(n[o])!=r;o++);o==n.length&&(console.warn("Didn't find a variant!",t,r,n),o=n.length-1);var a=o+1;a==n.length&&(a=0),t(e.utils.peekObservable(n[a]))},_getVariants=function(e){var t=e._variant;if("object"!=typeof e[t]||void 0===e[t]._widget||"string"!=typeof e[t]._options&&"boolean"!==e[t]._widget)throw console.error("Unexpected variant declaration",t,e[t]),"Unexpected variant declaration: cannot find property "+t+" or its _options string and it is not a boolean";return"string"==typeof e[t]._options?_getOptionsObjectKeys(e[t]._options):[!0,!1]},_makeComputedFunction=function(e,t,n,r,o,a,i){if(void 0===e){if(void 0===r.utils.unwrapObservable(i).type)throw console.error("Found a non-typed def ",e,i),"Found a non-typed def "+e;var l=r.utils.unwrapObservable(r.utils.unwrapObservable(i).type);if("object"!=typeof(e=t[l]))throw console.error("Found a non-object def ",e,"for",l),"Found a non-object def "+e}void 0===o&&void 0!==a&&a&&(o=i);var s="$root.content().",u=e._globalStyles;if(void 0!==u)for(var p in u)if(u.hasOwnProperty(p)){var b,c,v,d="$root.content().theme().scheme";if(u[p].substr(0,s.length)!=s)throw"UNEXPECTED globalStyle path ("+u[p]+") outside selfPath ("+s+")";v=u[p].substr(s.length),c=o,d.substr(0,s.length)==s?b=d.substr(s.length):(console.log("Scheme path doesn't match selfPath",d,s),b=d);for(var f=c,h=v.split("()."),_="",k=!0,w=0;w<h.length;w++)c=r.utils.unwrapObservable(c)[h[w]],k?"theme"==h[w]&&(k=!1):(_.length>0&&(_+="."),_+=h[w]);for(var g=b.split("()."),m=0;m<g.length;m++)f=r.utils.unwrapObservable(f)[g[m]];for(var y=p.split("."),O=i,F=0;F<y.length;F++)O=r.utils.unwrapObservable(O)[y[F]];if(!r.isObservable(O))throw"Unexpected non observable target "+p+"/"+_;O._defaultComputed=_makeComputed(O,c,!0,f,_,n)}if(void 0!==e._variant){for(var j=e._variant.split("."),S=i,x=r.utils.unwrapObservable(i),P=0;P<j.length;P++)S=r.utils.unwrapObservable(S)[j[P]];if(void 0!==S._defaultComputed&&(console.log("Found variant on a style property: beware variants should be only used on content properties because they don't match the theme fallback behaviour",e._variant),S=S._defaultComputed),void 0===S)throw console.error("Error looking for variant target",e._variant,i),"Error looking for variant target "+e._variant;x._nextVariant=_nextVariantFunction.bind(S,r,S,_getVariants(e))}for(var C in e)if(e.hasOwnProperty(C)){var B=e[C];if("object"==typeof B&&null!==B&&void 0!==B._context&&"block"==B._context){var A=o[C](),D=_makeComputedFunction(t[C],t,n,r,o,a,A);i[C](D)}else if("object"==typeof B&&null!==B&&"blocks"==B.type){for(var E,I,V,U=o[C](),W=U.blocks(),J=0;J<W.length;J++)E=r.utils.unwrapObservable(W[J]),I=r.utils.unwrapObservable(E.type),V=_makeComputedFunction(t[I],t,n,r,o,a,E),W[J](V);var N=U.blocks;_augmentBlocksObservable(N,_blockInstrumentFunction.bind(U,void 0,t,n,r,void 0,o,a)),o[C]._wrap=_makeBlocksWrap.bind(o[C],N._instrumentBlock),o[C]._unwrap=_unwrap.bind(o[C])}}return i},_augmentBlocksObservable=function(e,t){e._instrumentBlock=t,void 0===e.origPush&&(e.origPush=e.push,e.push=_makePush.bind(e),e.origSplice=e.splice,e.splice=_makeSplice.bind(e))},_makeBlocksWrap=function(e,t){var n=ko.toJS(t),r=n.blocks;n.blocks=[];var o=wrap(n)();_augmentBlocksObservable(o.blocks,e);for(var a=0;a<r.length;a++){var i=ko.toJS(r[a]);i.id="block_"+a,o.blocks.push(i)}this(o)},_makePush=function(){if(arguments.length>1)throw"Array push with multiple arguments not implemented";if(arguments.length>0&&ko.isObservable(arguments[0])&&("function"==typeof arguments[0]._unwrap?arguments[0]=arguments[0]._unwrap():console.log("WARN: pushing observable with no _unwrap function (TODO remove me, expected condition)")),ko.isObservable(arguments[0]))return this.origPush.apply(this,arguments);var e=this._instrumentBlock(arguments[0]);return this.origPush.apply(this,[e])},_makeSplice=function(){if(arguments.length>3)throw"Array splice with multiple objects not implemented";if(arguments.length>2&&ko.isObservable(arguments[2])&&("function"==typeof arguments[2]._unwrap?arguments[2]=arguments[2]._unwrap():console.log("WARN: splicing observable with no _unwrap function (TODO remove me, expected condition)")),arguments.length>2&&!ko.isObservable(arguments[2])){var e=this._instrumentBlock(arguments[2]);return this.origSplice.apply(this,[arguments[0],arguments[1],e])}return this.origSplice.apply(this,arguments)},_blockInstrumentFunction=function(e,t,n,r,o,a,i,l){void 0===o&&(o=l);var s=wrap(o);return s(_makeComputedFunction(e,t,n,r,a,i,s())),s._unwrap=_unwrap.bind(s),s},_wrap=function(e,t){this(ko.utils.unwrapObservable(e(ko,t,void 0,!0)))},_unwrap=function(){return ko.toJS(this)},_modelInstrument=function(e,t,n){var r=_blockInstrumentFunction.bind(void 0,t,n,n.themes),o=r(ko,e,void 0,!0);return o._wrap=_wrap.bind(o,r),o._unwrap=_unwrap.bind(o),o};module.exports=_modelInstrument;
...
(function (global){
"use strict";var ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,reactor=require("ko-reactor/dist/ko-reactor.min.js"),console=require("console-browserify"),undoManager=function(e,o){var t,n=ko.observableArray(),i=ko.observableArray(),d=0,r=0,l={levels:100,undoLabel:"undo (#COUNT#)",redoLabel:"redo (#COUNT#)"};o="object"==typeof o?ko.utils.extend(l,o):l;var u=function(e){1==d?a(e,i):2==d?a(e,n):0==d&&(a(e,n),i.removeAll())},a=function(e,n){if(n().length>0){var i=(r=e,void 0!==(d=n()[n().length-1]).mergedAction?d.mergedAction(r):null);if(null!==i)return void(n()[n().length-1]=i)}var d,r;n().length>=o.levels&&n.shift(),t=n,n.push(e)},c=function(e,o,n){return{name:ko.computed(function(){return ko.utils.unwrapObservable(e).replace(/#COUNT#/,n().length)}),enabled:ko.computed(function(){return 0!==n().length}),execute:function(){var e=n.pop();if(e){var i=d;d=o;var l=r;r=3,e(),s(t),r=l,d=i}return!0}}},s=function(e){if(void 0===e)throw"Unexpected operation: stack cleaner called with undefined stack";e().length>0&&void 0!==e()[e().length-1].mergedAction&&delete e()[e().length-1].mergedAction},f=function(e,o){var t=function(e,o){e(),o()}.bind(void 0,e,o);return void 0!==e.mergedAction&&(t.mergedAction=e.mergedAction),t},v=function(e,o,t){if(void 0!==o)e(o);else{if(!t)throw"Unexpected condition: no item and no child.oldValues!";if("added"!==t.status&&"deleted"!==t.status)throw"Unsupported item.status: "+t.status;void 0!==t.moved?"added"==t.status&&(e.splice(t.index,1),e.splice(t.moved,0,t.value)):"added"==t.status?e.splice(t.index,1):e.splice(t.index,0,t.value)}},m=function(e,o,t,n,i){return e.bind(void 0,t,n,i)},g=("function"==typeof reactor?reactor:ko.watch)(e,{depth:-1,oldValues:1,mutable:!0,tagFields:!0,async:!1},function(e,o,t){var n=void 0!==o.oldValues?o.oldValues[0]:void 0,i=m(v,e,o,n,t);1!=r&&(3==r?void 0!==i&&(i.mergedAction=function(e){return void 0!==e.mergeMe&&e.mergeMe?f(e,this):null},i.mergeMe=!0):void 0!==i&&(o.oldValues&&2==r&&(i.mergedAction=function(e,o,t){return"object"==typeof t.mergeableAction&&e==t.mergeableAction.child?this:null}.bind(i,o,t),i.mergeableAction={child:o,item:t}),!t||"deleted"!=t.status&&"added"!=t.status?t&&console.warn("Unsupported item.status",t.status,typeof t,t):(i.mergedAction=function(e,o,t){return"object"==typeof t.mergeableMove&&o.value==t.mergeableMove.item.value?f(t,this):null}.bind(i,o,t),i.mergeableMove={child:o,item:t})),void 0!==i&&u(i))},{});return{push:u,undoCommand:c(o.undoLabel,1,n),redoCommand:c(o.redoLabel,2,i),reset:function(){n.removeAll(),i.removeAll()},setModeOnce:function(){r=2,s(n)},setModeMerge:function(){r=3,s(n)},setModeNormal:function(){r=0,s(n)},setModeIgnore:function(){r=1,s(n)},setUndoActionMaker:function(e){m=e},dispose:function(){g.dispose()}}};module.exports=undoManager;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"console-browserify":6,"ko-reactor/dist/ko-reactor.min.js":16}],70:[function(require,module,exports){
(function (global){
"use strict";var listener,watchEnabled,ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,console=require("console-browserify"),_reference=function(e,n){for(var t,o,r=0,i=e;r<n.length;)switch(n.charAt(r)){case"(":")"==n.charAt(r+1)&&(i=i()),r+=2;break;case"[":o=n.indexOf("]",r),i=i[n.substring(r+1,o)],r=o+1;break;case".":-1==(t=n.indexOf("(",r))&&(t=n.length),-1==(o=n.indexOf("[",r))&&(o=n.length),o=Math.min(t,o),i=i[n.substring(r+1,o)],r=o}return i},_getPath=function(e,n){for(var t,o="",r=e.length,i=0;i<=r;i++)if(void 0!==(t=i<e.length?e[i]:n)._fieldName)ko.isObservable(t)&&(o+="()"),o+="."+t._fieldName;else if(i>0&&"function"==typeof e[i-1].pop){var a=ko.isObservable(e[i-1])?ko.utils.peekObservable(e[i-1]):e[i-1],c=ko.utils.arrayIndexOf(a,t);if(-1==c)throw console.error("Unexpected object not found in parent array",a,t,i,e.length,ko.toJS(a),ko.utils.unwrapObservable(t)),"Unexpected object not found in parent array";ko.isObservable(t)&&(o+="()"),o+="["+c+"]"}else if(0!==r||void 0!==t._fieldName)throw console.error("Unexpected parent with no _fieldName and no parent array",i,e,typeof t),"Unexpected parent with no _fieldName and no parent array";return o},makeDereferencedUndoAction=function(e,n,t,o,r){e(_reference(n,t),o,r)},_setListener=function(e){listener=e},makeUndoActionDereferenced=function(e,n,t,o,r,i){try{var a=_getPath(t,o);if("object"!=typeof r&&"function"!=typeof r||(r=ko.toJS(r)),void 0===i||"object"!=typeof i.value&&"function"!=typeof i.value||(i=ko.toJS(i)),void 0!==listener)try{listener(a,o,r,i)}catch(e){console.log("Undoserializer ignoring exception in listener callback")}return makeDereferencedUndoAction.bind(void 0,n,e,a,r,i)}catch(e){console.error("Exception processing undo",e,t,o,i)}},_watchEnabled=function(e){if(void 0===e)return watchEnabled;watchEnabled=e};module.exports={dereference:_getPath,reference:_reference,makeUndoAction:makeUndoActionDereferenced,setListener:_setListener,watchEnabled:_watchEnabled};
