...
* Copy the file `docker-compose.override.yml.tmpl` to `docker-compose.override.yml` using `mv docker-compose.override.yml.tmpl docker-compose.override.yml` and modify it if you need to.
