/** 
 * Mosaico - OpenSource Email Template Editor - v0.17.4 - 2018-07-25 
...
"use strict";var mensch=require("mensch"),own={}.hasOwnProperty,Selector=require("./selector"),Property=require("./property");exports.Selector=Selector,exports.Property=Property,exports.extract=function(e){for(var r=0,t=[],s="",n=0,o=e.length;n<o;n++){var p=e.charAt(n);r?("]"!==p&&")"!==p||r--,s+=p):","===p?(t.push(s),s=""):("["!==p&&"("!==p||r++,(s.length||","!==p&&"\n"!==p&&" "!==p)&&(s+=p))}return s.length&&t.push(s),t},exports.parseCSS=function(e){for(var r=mensch.parse(e,{position:!0,comments:!0}),t=void 0!==r.stylesheet&&r.stylesheet.rules?r.stylesheet.rules:[],s=[],n=0,o=t.length;n<o;n++)if("rule"==t[n].type)for(var p=t[n],a=p.selectors,i=0,l=a.length;i<l;i++)s.push([a[i],p.declarations]);return s},exports.getPreservedText=function(e,r){for(var t=mensch.parse(e,{position:!0,comments:!0}),s=void 0!==t.stylesheet&&t.stylesheet.rules?t.stylesheet.rules:[],n=[],o=s.length-1;o>=0;o--)(r.fontFaces&&"font-face"===s[o].type||r.mediaQueries&&"media"===s[o].type||r.keyFrames&&"keyframes"===s[o].type)&&n.unshift(mensch.stringify({stylesheet:{rules:[s[o]]}},{comments:!1,indentation:"  "})),s[o].position.start;return 0!==n.length&&"\n"+n.join("\n")+"\n"},exports.normalizeLineEndings=function(e){return e.replace(/\r\n/g,"\n").replace(/\n/g,"\r\n")},exports.compareFunc=function(e,r){for(var t=Math.min(e.length,r.length),s=0;s<t;s++)if(e[s]!==r[s])return e[s]>r[s]?1:-1;return e.length-r.length},exports.compare=function(e,r){return 1==exports.compareFunc(e,r)?e:r},exports.extend=function(e,r){for(var t in r)own.call(r,t)&&(e[t]=r[t]);return e},exports.getDefaultOptions=function(e){var r=exports.extend({extraCss:"",insertPreservedExtraCss:!0,applyStyleTags:!0,removeStyleTags:!0,preserveMediaQueries:!0,preserveFontFaces:!0,preserveKeyFrames:!0,applyWidthAttributes:!0,applyHeightAttributes:!0,applyAttributesTableElements:!0,url:""},e);return r.webResources=r.webResources||{},r};
